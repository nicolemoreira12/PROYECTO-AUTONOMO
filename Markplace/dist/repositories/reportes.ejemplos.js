...
exports.ejemploProductosMasVendidos = ejemploProductosMasVendidos;
exports.ejemploProductosConFiltroFecha = ejemploProductosConFiltroFecha;
exports.ejemploProductosMasRentables = ejemploProductosMasRentables;
...
exports.ejemploInventarioPorCategoria = ejemploInventarioPorCategoria;
exports.ejemploProductosStockBajo = ejemploProductosStockBajo;
exports.ejemploProductosAgotados = ejemploProductosAgotados;
...
async function ejemploInventarioPorCategoria() {
    ...
    const idCategoria = 2;
    const resultado = await reportesRepo.obtenerReporteInventario(paginacion, idCategoria);
...
async function ejemploProductosStockBajo() {
    ...
    const resultado = await reportesRepo.obtenerReporteInventario(paginacion, undefined, undefined, 'Stock Bajo');
...
async function ejemploProductosAgotados() {
    const paginacion = { pagina: 1, limite: 50 };
    const resultado = await reportesRepo.obtenerReporteInventario(paginacion, undefined, undefined, 'Agotado');
