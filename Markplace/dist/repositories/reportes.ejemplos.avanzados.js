...
exports.ejemploReporteOrdenesBasico = ejemploReporteOrdenesBasico;
exports.ejemploOrdenesPorEstado = ejemploOrdenesPorEstado;
exports.ejemploOrdenesDeUsuario = ejemploOrdenesDeUsuario;
exports.ejemploOrdenesPorFecha = ejemploOrdenesPorFecha;
exports.ejemploEstadisticasUsuario = ejemploEstadisticasUsuario;
exports.ejemploEstadisticasUsuarioPeriodo = ejemploEstadisticasUsuarioPeriodo;
exports.ejemploIngresosMensuales = ejemploIngresosMensuales;
exports.ejemploIngresosDiarios = ejemploIngresosDiarios;
exports.ejemploIngresosAnuales = ejemploIngresosAnuales;
exports.ejemploTendenciasDiarias = ejemploTendenciasDiarias;
exports.ejemploTendenciasPorCategoria = ejemploTendenciasPorCategoria;
exports.ejemploCompararMeses = ejemploCompararMeses;
exports.ejemploCompararTrimestres = ejemploCompararTrimestres;
exports.ejemploTopCompradores = ejemploTopCompradores;
exports.ejemploTopCompradoresAnual = ejemploTopCompradoresAnual;
exports.ejemploAbandonoCarrito = ejemploAbandonoCarrito;
exports.ejemploPreciosPorCategoria = ejemploPreciosPorCategoria;
exports.ejemploProyeccionVentas = ejemploProyeccionVentas;
exports.ejemploProyeccionSemestral = ejemploProyeccionSemestral;
exports.ejemploDashboardEjecutivo = ejemploDashboardEjecutivo;
const reportes_repository_1 = require("./reportes.repository");
const reportesRepo = new reportes_repository_1.ReportesRepository();
// ==================== REPORTES DE ORDENES ====================
...
async function ejemploOrdenesPorEstado() {
    ...
    const resultado = await reportesRepo.obtenerReporteOrdenes(paginacion, undefined, 'En Proceso');
...
async function ejemploOrdenesDeUsuario() {
    ...
    const idUsuario = 5;
    const resultado = await reportesRepo.obtenerReporteOrdenes(paginacion, undefined, undefined, idUsuario);
...
async function ejemploOrdenesPorFecha() {
    ...
    const resultado = await reportesRepo.obtenerReporteOrdenes(paginacion, filtro);
...
async function ejemploEstadisticasUsuarioPeriodo() {
    ...
    const estadisticas = await reportesRepo.obtenerEstadisticasUsuario(idUsuario, filtro);
...
async function ejemploTendenciasPorCategoria() {
    ...
    const idCategoria = 2;
    const tendencias = await reportesRepo.analizarTendencias(filtro, 'semana', idCategoria);
...
async function ejemploCompararMeses() {
    ...
    const finMesActual = new Date(fechaActual.getFullYear(), fechaActual.getMonth() + 1, 0);
    // Mes anterior
    ...
    const comparacion = await reportesRepo.compararPeriodos({ fechaInicio: inicioMesAnterior, fechaFin: finMesAnterior }, { fechaInicio: inicioMesActual, fechaFin: finMesActual });
...
async function ejemploDashboardEjecutivo() {
    ...
    const [metricas, topVendidos, topCompradores, ingresos, tendencias, proyeccion, abandono,] = await Promise.all([
